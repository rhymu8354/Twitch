...
provided by Twitch.TV for interfacing programs with the Twitch infrastructure.

## Usage

The `Twitch::Messaging` class is used to connect to Twitch chat, receiving
incoming messages from the Twitch chat server, and allowing the program to
participate in chat.
